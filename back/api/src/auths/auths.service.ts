...
export class AuthsService {
    ...
    private async newRefreshAndAccessToken(user: User, values: { userAgent: string; ipAddress: string }):
        Promise<{ accessToken: string; refreshToken: string }> {
            ...
            return {
              ...
              accessToken: sign({userId: user.id}, process.env.ACCESS_TOKEN, {expiresIn: '15m'})
            };
      }
